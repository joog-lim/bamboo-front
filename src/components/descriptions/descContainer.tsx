  ...
  return (
    <article className={s.descAboutWrapper}>
      <div>
        ...
        <p>두페이지 정도를 잡아먹는 경우</p>
        <p>한문장도 완성시키지 못하는 경우</p>
        ...
        <h3 className={s.title}>
          ...
          제보일 경우, 관리자들의 회의 아래 게시될 수 있다. 단 다음 기준들이
          엄격히 적용된다.
        </h3>
        <h4 className={s.bold}>
          1. 실명 거론의 경우 초성처리나 블라인드 처리로 수정된다.
        </h4>
        <h4 className={s.bold}>2. 육하원칙에 의거하여 작성되어있어야 한다.</h4>
        ...
        <h3 className={s.title}>
          제 3항: 이 외에 제 2조 1항의 기준에 해당되는 제보더라도, 논란의 소지가
          없다고 판단되는 범위 내에서 대나무숲 활성화를 위해 관리자의 재량으로
          게시글이 게시될 수 있다. 단, 다음 기준들이 적용된다.
        </h3>
        <h4 className={s.bold}>
